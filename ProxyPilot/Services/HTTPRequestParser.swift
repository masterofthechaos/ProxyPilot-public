...
enum HTTPRequestParser {
    ...
    static func parse(headerData: Data) -> Result<ParsedRequest, ParseError> {
    ...
    static func extractModel(from body: Data) -> String? {
        guard let json = try? JSONSerialization.jsonObject(with: body) as? [String: Any] else {
            return nil
        }
...
enum ModelFilter {
    ...
    static func isAllowed(_ requestedModel: String, in allowedModels: Set<String>) -> Bool {
