            ...
            return .init(tools: [
                Tool(
                    ...
                    inputSchema: jsonSchemaObject(properties: [
                        ...
                        "provider": stringProp("Upstream provider: openai, groq, zai, openrouter, xai, chutes, google, ollama, lmstudio"),
                ...
                Tool(
                    ...
                    inputSchema: jsonSchemaObject(properties: [
                        "provider": stringProp("Upstream provider (default: current proxy provider). Options: openai, groq, zai, openrouter, xai, chutes, google, ollama, lmstudio"),
